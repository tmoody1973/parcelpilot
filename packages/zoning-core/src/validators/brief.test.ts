...
import { DECISION_POLICY_V1, type BriefingOutput } from "@parcelpilot/contracts";
import { briefingContractHash, buildBriefingContract } from "../briefing-contract.ts";
import { S, bundle, contract, f, hash, item, record, valid } from "./brief.fixture.ts";
